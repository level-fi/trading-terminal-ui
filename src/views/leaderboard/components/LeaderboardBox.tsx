...
export const LeaderboardBox: React.FC<LeaderboardBoxProps> = ({
  ...
  return (
    <div className="container grid grid-cols-1 xl:grid-cols-2 grid-rows-2 grid-rows-1 xl:grid-rows-2 gap-x-0px xl:gap-x-86px gap-y-25px xl:gap-y-25px m-x-auto mt-40px xl:mt-50px mb-20px xl:px-0px pb-0px xl:pb-20px">
